...
function generatePDF($id, $name, $email, $dept_name, $semester, $contact, $result_courses)
{
    ...
    $html = '<html>
        ...
        <body>
            ...
            <h1 style="color:green">Marksheet</h1>
            <p><strong>Student ID: ' . $id . '</strong></p>
            <p><strong>Department: ' . $dept_name . '</strong></p>
            <p><strong>Email: ' . $email . '</strong></p>
            <p><strong>Student Name: ' . $name . '</strong></p>
            <p><strong>Semester/Year: ' . $semester . '</strong></p>
    ...
    // $html .= "<td style='text-align: center;'></td>";
    // $html .= "<td style='text-align: center;'></td>";
    // $html .= "<td style='text-align: center;'>Average CGPA: </td>";
    ...
    $html .="Total Credit Completed:". $totallCredit;
    // $html .= " <td style='text-align: center;'>" . $formattedNumber . "</td>";
    $html .= '</body></html>';
