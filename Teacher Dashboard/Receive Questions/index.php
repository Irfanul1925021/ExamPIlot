            ...
            <div class="content">
                ...
                <?php if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $storedDateTime = strtotime($row["time"]);
                        $currDateTime = time();
                        ...
                        echo "Current Time: $currDateTime <br>";

                        echo "Sent From: Exam Controller <br>";
                        echo '</div>';
                        if($currDateTime>= $storedDateTime){
                            echo '<div class="btn">';
                            ...
                            echo "This question will be available for download at " . date("Y-m-d H:i:s", $storedDatetime);
                            echo '</div>';
                        }
