    ...
    if (isset($_FILES["question"])) {
        ...
        if ($_FILES["question"]["error"] !== UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($_FILES["question"]["tmp_name"], $uploadDir . $questionFileName)) {
                ...
                $sql = "INSERT INTO send_question (course_code, course_name, semester, department_name, sender, recipient_teacher, question_file_path,encrypted_file_path,secret_key,iv,time) 
                VALUES ('$courseCode', '$courseName', '$semester', '$deptName', '$sentFrom', '$recipientTeacher', '$questionFileName','$encryptedFileName', '$encryptionKey','$iv','$time')";
    ...
    <div class="content">
        ...
        <div class="body">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="meeting-time">Choose the examination date:</label>
